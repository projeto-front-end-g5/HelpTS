...
function SolutionFullCard({ id }: ISolutionFullCard): JSX.Element {
  ...
  const fullCardToken = localStorage.getItem('token');
  return (
    <Container>
        ...
        <div className='second-top'>
          <div>
            <button className='botao-modal-edit' type='button'>
              {postId === solution.id && fullCardToken ? (
                <BsPencilFill />
              ) : (
                fullCardToken && <BsPencilFill />
              )}
            </button>
            <button
            ...
            >
              {postId === solution.id && buttonClick && fullCardToken ? (
                <FaTrashAlt />
              ) : (
                fullCardToken && <FaTrashAlt />
              )}
            </button>
          </div>
